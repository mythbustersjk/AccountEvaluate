...
def jc_calculation(jc_value):
    ...
    while jc_tool:
        ...
        if jc == "1":
            ...
            print(Fore.YELLOW + f'该客户将在{round(need_days.jc_need_days_formula())}天后成为基础户')
            ...
            print(
                Fore.YELLOW + f'该客户需要存入{round(need_found.jc_amount_formula() - float(current_balance), 2)}万元，'
...
def yx_calculation(yx_value):
    ...
    while yx_tool:
        ...
        if yx == "1":
            ...
            print(Fore.YELLOW + f'该客户将在{round(need_days.yx_need_days_formula())}天后成为基础户')
            ...
            print(
                Fore.YELLOW + f'该客户需要存入{round(need_found.yx_amount_formula() - float(current_balance), 2)}万元，'
